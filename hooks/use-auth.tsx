...
const rolePermissions: Record<UserRole, string[]> = {
  ...
  sales_agent: ["leads.view", "leads.edit", "calls.make", "reports.view", "performance.view", "employee.tools"],
  operation_manager: [
    "fms.view",
    "fms.edit",
    "fms.approve",
  ...
  operation_staff: ["fms.view", "fms.edit", "bookings.view", "bookings.edit", "reports.view", "employee.tools"],
  account_manager: [
    "payments.view",
    "payments.edit",
    "invoices.view",
  ...
  account_staff: ["payments.view", "payments.edit", "invoices.view", "reports.view", "employee.tools"],
  doctor: ["consultations.view", "consultations.edit", "prescriptions.create", "reports.view", "employee.tools"],
  front_office: ["bookings.view", "bookings.edit", "guests.view", "reports.view", "employee.tools"],
  hr_manager: [
    "users.view",
    "users.create",
    "users.edit",
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const login = async (email: string, password: string, company: string) => {
    try {
      const url = new URL(
        "https://script.google.com/macros/s/AKfycbzDC3m9yUuTeCska7osn17tIxixwtEt-sN_7tFLi9f8Yb34l9qEcxPg1dCF5KCwvH-i/exec"
      )
  ...
  const hasPermission = (permission: string) => {
    ...
    return user.permissions.includes("all") || user.permissions.includes(rolePermissions[user.role]?.includes(permission) ? permission : "")
  }
